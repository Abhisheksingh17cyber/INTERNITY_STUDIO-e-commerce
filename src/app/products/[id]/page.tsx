    ...
    <div className="pt-28 pb-16 max-w-7xl mx-auto px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <AnimateOnScroll animation="slide-right">
          <div className="relative aspect-square bg-luxury-dark rounded-lg overflow-hidden group">
            <Image
              src={product.image}
              alt={product.name}
              fill
              ...
              priority
            />
            <div className="absolute inset-4 border border-gold/10 rounded-lg pointer-events-none transition-all duration-500 group-hover:border-gold/25 group-hover:inset-3" />
          </div>
        </AnimateOnScroll>
        ...
        <div>
          ...
          <AnimateOnScroll animation="slide-up" delay={0.3}>
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="bg-luxury-card border border-luxury-border rounded-lg p-4 text-center transition-all duration-300 hover:border-gold/30 hover:shadow-lg hover:shadow-gold/5">
          ...
          <AnimateOnScroll animation="fade-in" delay={0.4}>
            <div className="flex gap-6 mt-8 text-xs text-luxury-muted">
              <div className="flex items-center gap-2 transition-colors duration-300 hover:text-gold">
